        ...
        public void xuatExcelDSSP_Nhap(List<SanPham> ListSanPham)
        {
            ...
            try
            {
                using (ExcelPackage p = new ExcelPackage())
                {
                    ...
                    p.Workbook.Properties.Title = "List of import products report";
                    p.Workbook.Worksheets.Add("Sheet1");
                    ExcelWorksheet worksheet = p.Workbook.Worksheets["Sheet1"];
                    worksheet.Name = "Sheet1";
                    worksheet.Cells.Style.Font.Size = 12;
                    worksheet.Cells.Style.Font.Name = "Arial";
                    string[] columnHeader = { "#", "Product name", "Product ID", "Quantity", "Supplier ID", "Original/Import price", "Selling price" };
                    var numberOfColumn = columnHeader.Count();
                    worksheet.Cells[1, 1].Value = "List of import products report";
